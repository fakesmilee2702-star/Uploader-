...
CREDIT = environ.get("CREDIT", "ᏗᏰᏂᎥᏕᏂᏋᏦ")
cookies_file_path = os.getenv("cookies_file_path", "youtube_cookies.txt")

TOTAL_USER = os.environ.get('TOTAL_USERS', '8412760331,7892999246,6233692970').split(',')
TOTAL_USERS = [int(user_id) for user_id in TOTAL_USER]

AUTH_USER = os.environ.get('AUTH_USERS', '8412760331').split(',')
